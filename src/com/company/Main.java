...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //define the filters
        RequestHandler filter1 = new ExistingContentCheckRequestHandler();
        RequestHandler filter2 = new PolicyCheckRequestHandler();
        RequestHandler filter3 = new RenderContentHandler();
        ...
        webServer.setFirstSuccesor(filter1);

        //add an observer to the web server
        webServer.attach(new FileLogger("logs.txt"));
